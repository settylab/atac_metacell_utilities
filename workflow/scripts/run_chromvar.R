...
count_matrix <- Matrix::readMM(sprintf("%s/sc_atac_counts.mtx", chromvar_dir))
count_matrix <- t(count_matrix)

nfrags <- readr::read_csv(sprintf("%s/sc_nfrags.csv", chromvar_dir))
...
tf_names <- readr::read_csv(sprintf("%s/chromvar_tf_names.csv", chromvar_dir))
insilico_chip_mat <- Matrix::readMM(sprintf("%s/bin_ins_chip.mtx", chromvar_dir))
...
write.csv(deviations, sprintf("%s/output/deviations.csv", chromvar_dir))
zs_deviations <- assay(dev, "z")
write.csv(zs_deviations, sprintf("%s/output/deviations_zs.csv", chromvar_dir))